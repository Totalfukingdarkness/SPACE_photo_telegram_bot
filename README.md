...
- `NASA_API` - Нужен для подключения к базе данных с фото. Можно сгенерировать на сайте [NASA](https://api.nasa.gov/#epic)
...
Полученое изображение сохраняется в папке указаной в `DIRECTORY_PATH`
